...
const messages = {
  zh: {
    ...
    "ai.operation.add_chart": "添加图表",
    "ai.operation.update_chart": "更新图表",
    "ai.operation.delete_chart": "删除图表",
    ...
    "preview.close": "关闭预览",
    "preview.charts": "图表预览",
    "preview.noCharts": "还没有图表。打开图表工作台，从当前工作表生成第一个图表。",
    "chart.dialogTitle": "图表工作台",
    "chart.description": "从当前工作表推断字段，生成可复用的图表配置。",
    "chart.close": "关闭图表工作台",
    "chart.localNote": "数据只在当前浏览器中处理",
    "chart.title": "图表标题",
    "chart.sheet": "数据工作表",
    "chart.range": "数据范围（可选）",
    "chart.rangePlaceholder": "例如 A1:F20，默认使用整张表",
    "chart.type": "图表类型",
    "chart.bar": "柱状图",
    "chart.line": "折线图",
    "chart.scatter": "散点图",
    "chart.histogram": "直方图",
    "chart.correlation": "相关矩阵",
    "chart.xAxis": "横轴字段",
    "chart.rowIndex": "使用行号",
    "chart.yAxis": "数值系列",
    "chart.correlationColumns": "参与计算的数值字段",
    "chart.aggregation": "重复类别聚合",
    "chart.sum": "求和",
    "chart.average": "平均值",
    "chart.count": "计数",
    "chart.add": "保存图表",
    "chart.preview": "实时预览",
    "chart.rows": "{{count}} 行数据",
    "chart.saved": "已保存图表",
    "chart.savedCount": "{{count}} 个图表",
    "chart.noSaved": "保存后，图表会出现在这里并随工作簿一起保存。",
    "chart.remove": "删除 {{title}}",
    "chart.noColumns": "当前工作表还没有可识别的字段。",
    "chart.noData": "暂无数据",
    "chart.noDataDescription": "需要至少一个标题行和一列可识别的数据。调整字段或范围后再试。",
    "chart.localData": "本地推断",
    "chart.savedSummary": "已保存图表：{{title}}",
    "chart.removedSummary": "已删除图表：{{title}}",
  ...
  en: {
    ...
    "ai.operation.add_chart": "Add chart",
    "ai.operation.update_chart": "Update chart",
    "ai.operation.delete_chart": "Delete chart",
    ...
    "preview.charts": "Chart preview",
    "preview.noCharts": "No charts yet. Open the chart workspace to create one from the current sheet.",
    "chart.dialogTitle": "Chart workspace",
    "chart.description": "Infer fields from the current sheet and save reusable chart configurations.",
    "chart.close": "Close chart workspace",
    "chart.localNote": "Data is processed locally in this browser",
    "chart.title": "Chart title",
    "chart.sheet": "Data worksheet",
    "chart.range": "Data range (optional)",
    "chart.rangePlaceholder": "For example A1:F20; defaults to the whole sheet",
    ...
    "chart.xAxis": "X-axis field",
    "chart.rowIndex": "Use row index",
    "chart.yAxis": "Value series",
    "chart.correlationColumns": "Numeric fields to correlate",
    "chart.aggregation": "Duplicate category aggregation",
    "chart.sum": "Sum",
    "chart.average": "Average",
    "chart.count": "Count",
    "chart.add": "Save chart",
    "chart.preview": "Live preview",
    "chart.rows": "{{count}} data rows",
    "chart.saved": "Saved charts",
    "chart.savedCount": "{{count}} charts",
    "chart.noSaved": "Saved charts appear here and travel with the workbook.",
    "chart.remove": "Delete {{title}}",
    "chart.noColumns": "No recognizable fields in this worksheet yet.",
    "chart.noData": "No data",
    "chart.noDataDescription": "Add a header row and at least one recognizable data column, then try again.",
    "chart.localData": "Inferred locally",
    "chart.savedSummary": "Saved chart: {{title}}",
    "chart.removedSummary": "Removed chart: {{title}}",
